        ...
        <div class="form-group">
            ...
            <input type="hidden" name="id" value="{{ $user->id }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fullname" value="{{ old('fullname', $user->fullname) }}" placeholder="Karina Monserrat Masache">    
                </div>
                <div class="form-group">
                    <label>
                    ...
                    <input type="text" name="document" value="{{ old('document', $user->document) }}" placeholder="1053835222">    
                </div>
                <div class="form-group">
                    <label>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{ old('email', $user->email) }}" placeholder="karinamasache@gmail.com">    
                </div>
                <div class="form-group">
                    <label>
                ...
                <div class="form-group">
                    <label>
                        ...
                        Birth Date:                    </label>
                    <input type="text" name="birthdate" value="{{ old('birthdate', $user->birthdate) }}" placeholder="1994/03/23">    
                </div>
                <div class="form-group">
                    <button type="submit">
